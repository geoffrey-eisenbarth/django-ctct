...
class Serializer[S: SerialModel](Manager[S]):
  ...
  def deserialize_related_obj_fields(
    self, data: JsonDict, parent_pk: int | None = None
  ) -> JsonDict:
    ...
    """
    Field = models.OneToOneField[models.Model] | models.ForeignKey[models.Model]
...
class ContactListRemoteManager(RemoteManager["ContactList"]):
  ...
  def add_list_memberships(
    ...
    if contact_list is not None:
      ...
      raise ValueError(_("Must pass either `contact_list` or `contact_lists`."))
